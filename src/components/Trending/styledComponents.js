...
export const MainBody = styled.li`
...
export const TrendingMainContainer = styled.li`
...
export const TrendingMenuContainer = styled.li`
  display: flex;
  flex-direction: row;
  align-items: center;
  padding: 7px;
...
export const LoaderContainer = styled.li`
  text-align: center;
`
export const FailureContainer = styled.li`
  display: flex;
